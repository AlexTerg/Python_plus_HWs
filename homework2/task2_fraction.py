...
def get_sum(fraction1: tuple, fraction2: tuple) -> str:
...
def get_prod(fraction1: tuple, fraction2: tuple) -> str:
...
sum_fr: str = get_sum(first_fraction, second_fraction)
prod_fr: str = get_prod(first_fraction, second_fraction)
