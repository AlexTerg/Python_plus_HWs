class Matrix:
    ...
    def __init__(self, matrix) -> None:
        ...
        for i in matrix:
            if len(i) != temp_len:
                raise IndexError(
                    'Все элементы матрицы должны быть одной длинны')
        self.matrix = matrix
    ...
    def __add__(self, other):
        ...
        if len(self.matrix) != len(other.matrix) or len(self.matrix[0]) != len(other.matrix[0]):
            raise IndexError('Матрицы должны быть одинаковые')
    ...
    def __mul__(self, other):
        ...
        if len(self.matrix[0]) != len(other.matrix):
            raise IndexError(
                "Количество строк первой матрицы должно совпадать с количеством столбцов второй матрицы")
